...
interface SelectSingleEnumSearchProps {
    label: string;
    placeholder?: string;
    error?: string;
    enumType: object;
...
const SelectSingleEnumSearch: React.FC<SelectSingleEnumSearchProps> = ({
    label,
    placeholder = label,
    error,
    enumType,
                            ...
                            filteredOptions.map((option) => (
                                ...
                                >
                                    ...
                                    {selectedOption?.key === option.key && (
                                        <FaCheck className="w-4 h-4 ml-auto text-template-color-primary" />
                                    )}
                                </li>
                            ))
                        ) : (
...
export default SelectSingleEnumSearch;
